...
public class Search2 extends javax.swing.JFrame {
    ...
    public static String[] search(String cat) {
        ...
        //splits reult into an array using , to separate each item.
        if (result.equals("")) {
            return new String[0];
        }
        return result.split(", ");
    ...
    private void initComponents() {
        ...
        rlist = new javax.swing.JTextArea();
        ...
        rlist.setColumns(20);
        rlist.setRows(5);
        jScrollPane1.setViewportView(rlist);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(sbox, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(sbtn)
    ...
    private void sbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sbtnActionPerformed
        ...
        rlist.setText("");
        String catSearch = sbox.getText();
        String result[] = search(catSearch);
        //print
        if(result.length==0)
            rlist.setText("No Products Found");
        else{
            for (int i = 0; i < result.length; i++) {
                rlist.append(result[i]+"\n");//.append adds to a textarea
    ...
    private javax.swing.JTextArea rlist;
